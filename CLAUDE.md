...
6. Nunca guardar ni pedir contraseñas. Las cuentas de portales se conectan con inicio de sesión personal en el navegador.
...
| Módulo | Qué hace |
|---|---|
| `jobflow/main.py` | App, rutas de perfiles, CV, búsqueda, importación, seguimiento. Incluye routers de `career`, `google_integration`, `portal_accounts`. |
...
.venv\Scripts\python.exe -m pytest -q                      # 42 pruebas
```
